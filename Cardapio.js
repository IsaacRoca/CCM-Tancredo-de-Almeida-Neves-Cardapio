...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cardapios = {
    1: {
      ...
      descricao: "Arroz simples, Feijão em caldo, Proteina animal, Legumes assados.",
      imagem: "Imagem 2.jpeg",
      subtitulo: "Informações Nutricionais",
      coluna1: "Proteínas: 35-50g",
      coluna2: "Calorias: 450-650kcal",
      coluna3: "Carboidratos: 50-80g",
      coluna4: "Lipidio: 10-20g",
      coluna5: "Sódio: 400-800mg"
    },
    2: {
      titulo: "Terça-feira",
      descricao: "Macarrão com molho, Proteina animal, Farofa d'água, Salada.",
      imagem: "macarrao.jpeg",
      subtitulo: "Informações Nutricionais",
      coluna1: "Proteínas: 35-55g",
      coluna2: "Calorias: 650-850kcal",
      coluna3: "Carboidratos: 80-110g",
      coluna4: "Lipidio: 20-45g",
      coluna5: "Sódio: 800-1500mg"
    },
    3: {
      titulo: "Quarta-feira",
      descricao: "Arroz verdinho, Feijão em caldo, Proteina animal, Legumes refogados.",
      imagem: "arroz_feijao_e_ovo.jpg",
      subtitulo: "Informações Nutricionais",
      coluna1: "Proteínas: 35-50g",
      coluna2: "Calorias: 500-700kcal",
      coluna3: "Carboidratos: 55-85g",
      coluna4: "Lipidio: 12-25g",
      coluna5: "Sódio: 500-900mg"
    },
    4: {
      titulo: "Quinta-feira",
      descricao: "Sanduiche natural, Chá aromático com frutas.",
      imagem: "quinta-feira.jpg",
      subtitulo: "Informações Nutricionais",
      coluna1: "Proteínas: 20-35g",
      coluna2: "Calorias: 300-550kcal",
      coluna3: "Carboidratos: 30-49g",
      coluna4: "Lipidio: 8-13g",
      coluna5: "Sódio: 500-800mg"
    },
    5: {
      titulo: "Sexta-feira",
      descricao: "Arroz simples, Tutu de feijão, Proteina animal com molho, Legumes refogados.",
      imagem: "segunda-feira.jpg",
      subtitulo: "Informações Nutricionais",
      coluna1: "Proteínas: 35-55g",
      coluna2: "Calorias: 650-950kcal",
      coluna3: "Carboidratos: 80-120g",
      coluna4: "Lipidio: 20-50g",
      coluna5: "Sódio: 800-1200mg"
    },
  };
  ...
  const cardapiosPorData = {
    ...
    "2025-11-24":{
  titulo: "Segunda-feira",
  descricao: "Macarrão ao molho, Proteína animal, Legumes refogados, Salada",
  imagem: "macarrao5.webp",
  subtitulo: "Informações Nutricionais",
  coluna1: "Proteínas: 41 g",
  coluna2: "Calorias: 525 kcal",
  coluna3: "Carboidratos: 48 g",
  coluna4: "Lipídios: 17 g",
  coluna5: "Sódio: 625 mg",
},

"2025-11-25":{
  titulo: "Terça-feira",
  descricao: "Arroz simples, Feijão em caldo, Proteína animal, Legumes assados",
  imagem: "imagem 3.jpg",
  subtitulo: "Informações Nutricionais",
  coluna1: "Proteínas: 42 g",
  coluna2: "Calorias: 526 kcal",
  coluna3: "Carboidratos: 62 g",
  coluna4: "Lipídios: 10 g",
  coluna5: "Sódio: 510 mg",
},

"2025-11-26":{
  titulo: "Quarta-feira",
  descricao: "Arroz simples, Feijão em caldo, Proteína animal, Legumes refogados",
  imagem: "arroz_e_feijao.webp",
  subtitulo: "Informações Nutricionais",
  coluna1: "Proteínas: 12,0 g",
  coluna2: "Calorias: 422 kcal",
  coluna3: "Carboidratos: 25,5 g",
  coluna4: "Lipídios: 28,0 g",
  coluna5: "Sódio: 705 mg",
},

"2025-11-27":{
  titulo: "Quinta-feira",
  descricao: "Torta salgada, Chá ou suco",
  imagem: "torta4.webp",
  subtitulo: "Informações Nutricionais",
  coluna1: "Proteínas: 13,5 g",
  coluna2: "Calorias: 422-510 kcal",
  coluna3: "Carboidratos: 25,5-46,0 g",
  coluna4: "Lipídios: 28,5 g",
  coluna5: "Sódio: 702 mg",
},

"2025-11-28":{
  titulo: "Sexta-feira",
  descricao: "Arroz primavera, Feijão em caldo, Proteína animal com molho, Salada",
  imagem: "arroz2.jpeg",
  subtitulo: "Informações Nutricionais",
  coluna1: "Proteínas: 41,0 g",
  coluna2: "Calorias: 561 kcal",
  coluna3: "Carboidratos: 64,0 g",
  coluna4: "Lipídios: 14,5 g",
  coluna5: "Sódio: 454 mg",
 }
}

// ABRIR POPUP com animação
...
if (popup) {
  popup.addEventListener("click", (e) => {
    if (e.target === popup) fecharPopupAnimado();
  });
}
...
function fecharPopupAnimado() {
  ...
  // Espera fim da animação para esconder
  setTimeout(() => {
    popup.style.display = "none";
  }, 250); // MESMO TEMPO do CSS (0.25s)
}
  ...
  sextaAtual.setDate(segundaAtual.getDate() + 4); 

  // CORREÇÃO AQUI ⬇⬇⬇
  const clicked = new Date(`${dataISO}T00:00:00`);
  // ------------------
